...
public class RollerIOTalonFX implements RollerIO {
  ...
  public boolean
      isRollerMovingForward() { // Simple detection of the roller moving forward within tolerance
    return getRollerVelocity() > IntakeConstants.ROLLER_VELOCITY_TOLERANCE;
  }

  public boolean
      isRollerMovingBackward() { // Simple detection of the roller moving backward within tolerance
    return getRollerVelocity() < -IntakeConstants.ROLLER_VELOCITY_TOLERANCE;
  }
