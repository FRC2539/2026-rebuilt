...
public class PivotConstants {
  ...
  public static final Rotation2d intakeUpPosition = Rotation2d.fromRotations(1.008);
  public static final Rotation2d intakeDownPosition = Rotation2d.fromRotations(.283447);
