...
public class TunerConstants {
  ...
  private static final TalonFXConfiguration driveInitialConfigs = new TalonFXConfiguration().withCurrentLimits(new CurrentLimitsConfigs().withSupplyCurrentLimit(Amps.of(40)).withSupplyCurrentLimitEnable(true));
  ...
  private static final Angle kFrontLeftEncoderOffset = Rotations.of(0.239013671875);
  ...
  private static final Angle kBackLeftEncoderOffset = Rotations.of(0.26025390625);
